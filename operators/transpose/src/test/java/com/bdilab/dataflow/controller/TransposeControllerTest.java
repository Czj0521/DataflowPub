...
public class TransposeControllerTest {
  ...
  public void testTranspose(HashMap<String, Object> map) {
    TransposeDescription transposeDescription = new TransposeDescription("transpose",
        "promotion_csv", 2000);
    ...
    transposeDescription.setAttributeWithAggregationMap(
        (Map<String, String>) map.get("attributeWithAggregationMap"));
