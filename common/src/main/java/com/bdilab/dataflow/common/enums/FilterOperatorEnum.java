...
public enum FilterOperatorEnum {
    ...
    STRING_CONTAINS("string", "contains", OperatorConstants.COLUMN_MAGIC_NUMBER + " like '%" + OperatorConstants.VALUE_MAGIC_NUMBER + "%'", false),
    STRING_CONTAINS_ANY("string", "contains any", OperatorConstants.COLUMN_MAGIC_NUMBER + " like '%" + OperatorConstants.VALUE_MAGIC_NUMBER + "%'", false),
    STRING_CONTAINS_ALL("string", "contains all", OperatorConstants.COLUMN_MAGIC_NUMBER + " like '%" + OperatorConstants.VALUE_MAGIC_NUMBER + "%'", false),
    ...
    STRING_NOT_CONTAINS("string", "does not contains", OperatorConstants.COLUMN_MAGIC_NUMBER + " not like '%" + OperatorConstants.VALUE_MAGIC_NUMBER + "%'", false),
    /**
     * numeric
     */
