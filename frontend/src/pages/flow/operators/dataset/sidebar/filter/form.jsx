		  ...
		  <Row gutter={24}>
				<Col span={6} key={`filter-${i}`}>
					...
					initialValue={'Where'}
					  name={`filter-${i}`}
					>
					  <Input defaultValue={'Where'}  disabled={true}    style={{color:'white',background:'#282820',width:'100%',borderColor:'#2e3c51'}} size={'small'}/>
					</Form.Item>
				</Col>
			  <Col span={6} key={`column-${i}`}>
					...
					<Select onChange={onChange}
								dropdownStyle={{color:'white',background:'#282820'}}  size={'small'}>
								{
									column ? 
