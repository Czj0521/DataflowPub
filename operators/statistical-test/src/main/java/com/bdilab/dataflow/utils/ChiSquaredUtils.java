...
public class ChiSquaredUtils {
  public  double main(List<Double> datalist1,List<Double> datalist2) {
//    List<Double> datalist1 = Arrays.asList(1374D,500D,72D,1544D,839D,10D,1003D,6D,381D,724D,0D,0D);
//    List<Double> datalist2 = Arrays.asList(736D,229D,48D,841D,456D,3D,617D,5D,0D,0D,211D,401D);
